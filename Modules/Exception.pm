...
=head2 throw
  ...
  Example    : use Exception qw(throw);
...
=head2 warning
  ...
  Example    : use Exception qw(warning)
               warning('This is a warning');
...
=head2 info
  ...
  Example    : use Exception qw(verbose info)
...
=head2 verbose
  ...
  Arg [1]    : (optional) int 
  Example    : use Exception qw(verbose warning);
...
=head2 stack_trace_dump
  ...
  Example    : use Exception qw(stack_trace_dump);
...
=head2 stack_trace
  ...
  Arg [1]    : none
  Example    : use Exception qw(stack_trace)
...
=head2 deprecate
  ...
  Example    : use Exception qw(deprecate)
               sub old_sub {
...
=head2 try/catch
  ...
  Example    : use Exception qw(throw try catch)
               The syntax is:
